...
set_property PACKAGE_PIN W19 [get_ports i_btn0]
    set_property IOSTANDARD LVCMOS33 [get_ports i_btn0]
set_property PACKAGE_PIN T17 [get_ports i_btn1]
    set_property IOSTANDARD LVCMOS33 [get_ports i_btn1]
